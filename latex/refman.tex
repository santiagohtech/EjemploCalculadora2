...
\input{namespacemainfuntion}
\chapter{Documentación de clases}
\input{classdialogpb_1_1_dialog}
\input{classmainfuntion_1_1_main_window}
\input{classmainwindow__ui_1_1_ui___main_window}
\chapter{Documentación de archivos}
\input{dialogpb_8py}
\input{mainfuntion_8py}
